...
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module './Button.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* eslint-disable */
// @ts-nocheck
// @ts-ignore
...
/* harmony default export */ __webpack_exports__["default"] = ({
  title: 'Example/Button',
  component: Object(function webpackMissingModule() { var e = new Error("Cannot find module './Button.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
  // More on argTypes: https://storybook.js.org/docs/vue/api/argtypes
  argTypes: {
    backgroundColor: {
      control: 'color'
...
var Template = function (args) {
  return {
    // Components used in your story `template` are defined in the `components` object
    components: {
      MyButton: Object(function webpackMissingModule() { var e = new Error("Cannot find module './Button.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
    },
    // The story's `args` need to be mapped into the template through the `setup()` method
    setup: function () {
      return {
...
//# sourceMappingURL=main.e48d56991bd7e115c54d.hot-update.js.map